// //This program lets you input a year and it will return the chinese zodiac of that year //The program features basic OOP and modular arithmetic

#include using namespace std;//BAD PRACTICE!!!
